...
const TeamMemberSingleImage = ({ img1 }) => {
  ...
  return (
    <div className="relative w-[360px] teamImg h-[360px] border-4 border-[#0ab99d] overflow-hidden cursor-pointer">
      <img
        src={img1}
      ...
      />
      <div className="flex justify-between items-center bg-white absolute w-4/5 left-1/2 -translate-x-1/2 bottom-3 p-4 rounded-md z-10">
        <div>
